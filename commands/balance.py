...
async def balance_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        try:
            bnb_balance = wallet.get_bnb_balance(valid_address, status_callback=status_callback)
        ...
        for token_item in popular_tokens:
            try:
                ...
                token_info = wallet.get_token_balance(token_item['address'], valid_address, status_callback=status_callback)
